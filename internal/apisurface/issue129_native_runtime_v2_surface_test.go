...
func TestIssue129NativeRuntimeV2SurfaceIsClosedAndValuePreserving(t *testing.T) {
	...
	want := map[string]string{
		...
		"type NativeValueV2":               `type NativeValueV2 struct{ Null *bool "json:\"null,omitempty\""; Boolean *bool "json:\"boolean,omitempty\""; Integer *int64 "json:\"integer,omitempty\""; Float *float64 "json:\"float,omitempty\""; Number *string "json:\"number,omitempty\""; String *string "json:\"string,omitempty\""; Array *[]NativeValueV2 "json:\"array,omitempty\""; Object *map[string]NativeValueV2 "json:\"object,omitempty\"" }`,
	}

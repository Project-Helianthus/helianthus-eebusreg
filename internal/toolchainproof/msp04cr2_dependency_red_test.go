...
func TestMSP05PDependencyClosureUsesReviewedHelianthusReleases(t *testing.T) {
	...
	want := []struct {
		...
		{path: "github.com/Project-Helianthus/helianthus-eebus-go", version: "v0.7.1-helianthus.15"},
		{path: "github.com/Project-Helianthus/helianthus-ship-go", version: "v0.6.1-helianthus.13"},

...
require github.com/Project-Helianthus/helianthus-eebus-go v0.7.1-helianthus.7
`)
	...
	if !strings.Contains(string(output), "github.com/Project-Helianthus/helianthus-eebus-go@v0.7.1-helianthus.7") {
...
func TestMSP05PToolchainScriptDeclaresReviewedRuntimeClosure(t *testing.T) {
	...
	for _, stale := range []string{"v0.7.1-helianthus.1", "v0.7.1-helianthus.3", "v0.7.1-helianthus.4", "v0.6.1-helianthus.2", "v0.6.1-helianthus.4", "v0.6.1-helianthus.5"} {

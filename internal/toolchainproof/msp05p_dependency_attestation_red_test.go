...
require github.com/Project-Helianthus/helianthus-eebus-go v0.7.1-helianthus.17
`)
	...
	if !strings.Contains(string(output), "github.com/Project-Helianthus/helianthus-eebus-go@v0.7.1-helianthus.17") {
...
func TestMSP05PToolchainScriptDeclaresReviewedRuntimeClosure(t *testing.T) {
	...
	for _, required := range []struct {
	...
	}{
		{
			...
			version: "v0.7.1-helianthus.17",
		},
		{
			name:    "ship",
			path:    "github.com/Project-Helianthus/helianthus-ship-go",
			version: "v0.6.1-helianthus.15",
		},
		{
			name:    "spine",

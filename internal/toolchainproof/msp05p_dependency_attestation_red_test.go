...
require github.com/Project-Helianthus/helianthus-eebus-go v0.7.1-helianthus.10
`)
	...
	if !strings.Contains(string(output), "github.com/Project-Helianthus/helianthus-eebus-go@v0.7.1-helianthus.10") {
